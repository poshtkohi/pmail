...
namespace Cyber.email
{
	public class Compose : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			//else this.Response.Redirect("Compose.aspx");
		}
		//------------------------------------------------------------------
		...
		private void send_Click(object sender, System.EventArgs e)
		{
			...
			if(to == null || to == "")
			{
				this.ToError.Text = "*To field is empty.";
			...
			else
			{
				...
				if(!rex.IsMatch(to))
				{
					this.ToError.Text = "*Letters of To field is invalid.";
					this.ToError.Visible = true;
					return ;
				}
				else
			...
			if(cc != null && cc != "")
			{
				...
				if(!rex.IsMatch(cc))
				{
					this.CcError.Text = "*Letters of Cc field is invalid.";
			...
			if(bcc != null && bcc != "")
			{
				if(cc == null || cc == "")
				{
					this.CcError.Text = "*You must first fill Cc field.";
					this.CcError.Visible = true;
					this.bcc.Text = "";
					return ;
				}
				...
				if(!rex.IsMatch(bcc))
				{
					this.BccError.Text = "*Letters of Bcc field is invalid.";
			...
			{
				this.SubjectError.Text = "*Subject field is empty.";
			...
			{
				this.MessageError.Text = "*Message body field is empty.";
			...
			else
			{
				...
				{
					this.MessageError.Text = "*Message must be less than 500KB.";
					this.MessageError.Visible = true;
					return ;
				}
				else 
