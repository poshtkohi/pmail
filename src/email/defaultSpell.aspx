...
<script runat="server">
    ...
    protected void Page_Load(Object Src, EventArgs E) {
            if (!IsPostBack) {
                ...
                message.Text = "<H3><FONT face=arial><FONT color=#008000>Free</FONT>TextBox</FONT></H3><P>type here...</P></FONT>";
            }
    }

    protected void SaveButton_Click(Object Src, EventArgs E) {

            Output.Text = "<h3>Output</h3><div class=\"CodeBlock\">" + message.Text + "</div>" +
                "<h3>HTML</h3><div class=\"CodeBlock\">" + Server.HtmlEncode(message.Text).Replace("\n","<br>") + "</div>";
    }
...
<FTB:FREETEXTBOX id="message" runat="Server">
    <TOOLBARS>
