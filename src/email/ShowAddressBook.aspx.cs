	...
	public class ShowAddressBook : System.Web.UI.Page
	{
		...
		private void save_Click(object sender, System.EventArgs e)
		{
			if(this.FirstName.Text != null || this.FirstName.Text != "")
			{
				...
				{
					this.FirstNameError.Text = "*First Name must be fewer than 50 charahters.";
			...
			if(this.LastName.Text != null || this.LastName.Text != "")
			{
				...
				{
					this.LastNameError.Text = "*Last Name must be fewer than 50 characters.";
			...
			{
				this.EmailError.Text = "*You must type an email.";
			...
			if(this.Email.Text != null || this.Email.Text != "")
			{
				...
				{
					this.EmailError.Text = "*Email must be fewer than 50 characters.";
				...
				else
				{
					...
					{
						this.EmailError.Text = "*Letters of Email field is invalid.";
						this.PanelMain.Visible = false;
						this.EmailError.Visible = true;
						return ;
					}
			...
			if(this.Phone.Text != null || this.Phone.Text != "")
			{
				...
				{
					this.PhoneError.Text = "*Phone must be fewer than 50 charahters.";
